...
import { type AgentState, type BetaMessageParam, type InternalTool, type AgentInstance, isAgentInstance } from '@agentry/core';
...
export function getRegisteredTools(handle: AgentHandle): string[] {
  ...
  // Get the first child which is the actual agent element
